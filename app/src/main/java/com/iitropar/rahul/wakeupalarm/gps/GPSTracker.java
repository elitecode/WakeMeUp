package com.iitropar.rahul.wakeupalarm.gps;
...
public class GPSTracker extends Service implements LocationListener {
    ...
    public Location getLocation() {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                Toast.makeText(mContext,"No gps No Network Provider found.",Toast.LENGTH_LONG).show() ;
    ...
    public double getLatitude(){
        Log.d(TAG,"lat ke andar") ;
        if(location != null){
            Log.d(TAG,"not null") ;
            latitude = location.getLatitude();
        }else{
            getLocation();
            Log.d(TAG,"phir request") ;
            if (location != null){
                latitude = location.getLatitude() ;
            }
        }
